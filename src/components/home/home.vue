  ...
  <div id="home" class="home">
    <div class="home-box">
      ...
      <div class="enterprise">
        ...
        <swiper class="enterprise-count" :options="enterpriseSwiperOption">
          <swiper-slide
            ...
            <router-link :to="'/enterprise/details/' + enterpriseList.id" tag="div" class="pic"><img :src="enterpriseList.picUrl" alt=""></router-link>
      ...
      <div class="demo">
        ...
        <ul class="demo-count">
          <router-link :to="'/demo/demoDetails/' + demoList.id" tag="li" class="demo-list"
...
export default {
  ...
  mounted(){//模板编译完成
    this.$http({
      ...
      // 请求失败回调
      console.log("error from home.vue");
    });
  }
}
</script>
